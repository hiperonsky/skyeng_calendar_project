<?php
// Файл: server/generate.php — сохраняет server/ics/{teacher_id}.ics

// Если запущен из CLI, эмулируем PATH_INFO
if (php_sapi_name() === 'cli' && isset($argv[1])) {
    $_SERVER['PATH_INFO'] = '/' . $argv[1] . '.ics';
}
...
// Получаем teacher_id из URL или CLI
